...
final BeerServiceV2 beerServiceV2;
	...
	@PostMapping
	public ResponseEntity<HttpHeaders> createBeer(@Valid @RequestBody BeerDtoV2 beerDtoV2){
	...
	@PutMapping("/{beerId}")
	public ResponseEntity<Void> updateBeer(@PathVariable("beerId") UUID beerId, @Valid @RequestBody BeerDtoV2 beerDtoV2){
